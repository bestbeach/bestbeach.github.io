...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [1501030.851852, 5576293.885841, 1588072.841022, 5619455.862139], maxZoom: 16, minZoom: 1
    })
});
...
map.getView().fit([1501030.851852, 5576293.885841, 1588072.841022, 5619455.862139], map.getSize());
